...
function parseScriptFragment(code, locationCalculator, parserOptions, useSpecifiedParser) {
    try {
        const result = parseScript(code, parserOptions, Boolean(useSpecifiedParser));
...
function parseScript(code, parserOptions, useSpecifiedParser = true) {
    const parser = typeof parserOptions.parser === "string" && useSpecifiedParser
        ?
